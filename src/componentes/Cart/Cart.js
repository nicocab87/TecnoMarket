...
const Cart = ()=> {
  ...
  return (
    <div className='cart'>
        ...
        <button onClick={()=> clearCart()} className='button is-danger limpiarCarrito'>Limpiar carrito </button>
        <Link className='pagarCart button is-link' to='/checkout'>checkout</Link>
    </div>
  )
}
